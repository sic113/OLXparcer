...
def get_selenium_data():
    ...
    for link in list:
        ...
        try:
            print(f"Работаю с объявлением №:{n}:")
            print(link)
            driver.get(link)
            # sleep(randint(3,5))
            try:
                ...
                print(26*"- ")
                print(f"Ошибка в объявлении №:{n} ищу по ВТОРОМУ пути")
                try:
                    # sleep(randint(2, 4))
                    ...
                    print(f"Ошибка в объявлении №:{n} ищу по ТРЕТЬЕМУ пути")
                    try:
                        # sleep(randint(2, 4))
                        login_button = driver.find_element_by_xpath(
                        ...
                        print(f"Ошибка в объявлении №:{n} ищу по ЧЕТВЕРТОМУ пути")
                        try:
                            # sleep(randint(2, 4))
                            login_button = driver.find_element_by_xpath(
                            ...
                            # print(ex)
                            print(f"Ошибка в объявлении №:{n} ищу по ПЯТОМУ пути")
                            try:
                                # sleep(randint(2, 4))
                                login_button = driver.find_element_by_xpath(
                                ...
                                print(f"Ошибка в объявлении №:{n} ищу по ШЕСТОМУ пути")
                                try:
                                    # sleep(randint(2, 4))
                                    login_button = driver.find_element_by_xpath(
                                    ...
                                    print(f"Ошибка в объявлении №:{n} ищу по CЕДЬМОМУ пути")
                                    try:
                                        # sleep(randint(2, 4))
                                        login_button = driver.find_element_by_xpath(
                                        ...
                                        print(f"Ошибка в объявлении №:{n} ищу по ВОСЬМОМУ пути")
                                        try:
                                            # sleep(randint(2, 4))
                                            login_button = driver.find_element_by_xpath(
                                            ...
                                            print(f"Ошибка в объявлении №:{n} ищу по ДЕВЯТОМУ пути")
                                            try:
                                                # sleep(randint(2, 4))
                                                login_button = driver.find_element_by_xpath(
            ...
            sleep(randint(1,3))
            with open(f"{data_folder_path}/obyavlenie/{n}_{html_name}", "w") as file:
                file.write(driver.page_source)
            print(f"HTML объявления №:{n} успешно сохранен, осталось объявлений: {len(list)-n}\n")
            n += 1
...
def parce_and_csv():
    ...
    try:
        ...
        for html in nazvaniya:
            ...
            try:
                link = html.split("_")[1]
                link = "https://www.olx.ua/obyavlenie/" + link
                print(link)
            except:
                link = "-"
